...
<MainScreen>:
    BoxLayout:
        ...
        BoxLayout:
            ...
            Button:
                background_normal: '"Documents\Programacion\Talleres\ticket.png"'
                background_down: '"Documents\Programacion\Talleres\ticket.png"'
                border: (0, 0, 0, 0)
            ...
            Button:
                background_normal: '"Documents\Programacion\Talleres\palomitas.png"'
                background_down: '"Documents\Programacion\Talleres\palomitas.png"'
                border: (0, 0, 0, 0)
                background_color: 1, 1, 1, 1
                size_hint: (None, None)
                size: (250, 250)
